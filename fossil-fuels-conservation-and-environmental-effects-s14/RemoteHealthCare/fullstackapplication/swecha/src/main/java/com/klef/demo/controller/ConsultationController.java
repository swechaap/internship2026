...
public class ConsultationController {
    ...
    @Autowired
    private com.klef.demo.repository.ConsultationRoomRepository roomRepository;
    ...
    public ResponseEntity<Consultation> updateStatus(@PathVariable Long id, @RequestBody Map<String, String> body) {
        ...
        return consultationRepository.findById(id).map(c -> {
            ...
            if ("Approved".equalsIgnoreCase(status)) {
                ...
                com.klef.demo.entity.ConsultationRoom room = new com.klef.demo.entity.ConsultationRoom();
